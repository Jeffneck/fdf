...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/24 10:41:13 by hanglade          #+#    #+#             */
/*   Updated: 2024/01/24 10:52:49 by hanglade         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//*****************RENDER_IMG
//render_img
void		transform_proj_mapelem(t_fdf *p_fdf, t_map_elem *p_map_el,
				int flag);
int			transform_base_mapelem(t_fdf *p_fdf, t_map_elem *p_map_el);
void		put_view_in_img(t_fdf *p_fdf, t_imgstruct *p_img,
				t_map_elem **map);
